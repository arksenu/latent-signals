"""
Exa Discovery Probe for Notion backtest case.
Signal: Evernote frustration (2016 price hike, device limits, bloat).
Date range: 2017-03 to 2018-02.
"""
...
# Queries simulating what a user would ask the discovery layer
# for "note-taking and workspace" market frustration
QUERIES_GENERAL = [
    "people frustrated with note taking apps",
    "Evernote alternative",
    "Evernote frustration price increase",
    "best note taking app for teams",
    "why people are leaving Evernote",
    "note taking app complaints",
    "workspace tool for organizing notes and documents",
    "Evernote too expensive device limit",
]

QUERIES_REDDIT = [
    "people frustrated with Evernote",
    "looking for Evernote alternative",
    "Evernote price increase complaints",
    "note taking app frustration",
    "why I left Evernote",
    "best note taking app replacement",
    "Evernote device limit frustration",
    "workspace app for notes and collaboration",
]

QUERIES_HN = [
    "Evernote frustration",
    "Evernote alternative",
    "note taking app",
    "Evernote pricing",
]
...
def main():
    ...
    out_path = "data/discovery_probe_notion.json"
